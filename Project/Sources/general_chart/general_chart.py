...
# general_list = []
# def scrap_data(service, region):
#     calc = 0
#     for i in service.find():
#         if region+str(calc) in i:
#             sortted = sorted(i[region+str(calc)].split())
#             if len(sortted) > 3:
#                 check_case = sortted[0].lower() + sortted[1].lower() + sortted[2].lower() + sortted[3].lower()
...
#
#
# scrap_data(spotify_col, "song-")
# scrap_data(deezer_col, "song-")
# print("Done")
